...
审计/监管方用法（不需要账本，不需要联系出具方）：
    ...
    python3 tg_verify.py decision_0007.json --ca /path/to/tsa_ca.pem
...
def main() -> int:
    ...
    if args.json:
        print(json.dumps({"ok": r.ok, "checks": r.checks, "gen_time": r.gen_time,
                          "tsa": r.tsa_subject, "errors": r.errors},
