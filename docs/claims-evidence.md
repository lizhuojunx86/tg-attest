...
| 5 | "41.4% of `epsActual` values differ between first-seen and final, and 15.3% of those flip a trading decision" | Measurement from the TraceGuard project on a commercial feed. No data or code in this repo reproduces it. Attributed in the text as the author's own prior measurement. | **Unverifiable here** |
